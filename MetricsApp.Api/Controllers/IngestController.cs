...
public class IngestController : ControllerBase
{
    ...
    public async Task<IActionResult> Post([FromBody] IngestApiRequest ingestRequest)
    {
        if (ingestRequest == null || ingestRequest.Events == null || !ingestRequest.Events.Any())
        {
            ...
            return BadRequest(new QueryApiErrorResponse("Request body must contain a non-empty 'events' array.",
                "InvalidInput"));
        }
        ...
        catch (System.Exception ex)
        {
            ...
            return StatusCode(StatusCodes.Status500InternalServerError,
                new QueryApiErrorResponse("An error occurred while queueing events.", "InternalServerError",
                    ex.Message));
        }
    }
}