...
var otlpCollector = builder.AddContainer("otel-collector", "otel/opentelemetry-collector-contrib", "latest")
    ...
    .WithHttpEndpoint(8888, name: "metrics")
    .WithHttpEndpoint(8889, name: "pprof");
...
var jaeger = builder.AddContainer("jaeger", "jaegertracing/all-in-one", "latest")
    ...
    .WithHttpEndpoint(14268, name: "jaeger-collector")
    .WithHttpEndpoint(4317, name: "jaeger-otlp-grpc")
    .WithHttpEndpoint(4318, name: "jaeger-otlp-http");
